    ...
    <div class="register">
        <section class="form_container">
            <div class="manage_tip">
                <span class="title">小米在线后台管理系统</span>
                <el-form :model="registerUser" status-icon :rules="rules" ref="registerFrom" label-width="80px" class="registerForm">
                    ...
                    <el-form-item label="选择身份">
                        <el-select  value="" v-model="registerUser.identity">
